...
public class Constants {
    ...
    public final static String ACTION_Z_AVAILABLE = "smart.thermostat.ACTION_Z_AVAILABLE";
    ...
    public final static String DATA_Pitch = "smart.thermostat.DATA_TEMPERATURE";
